        ...
        <div className=" py-5">
          ...
          <div className="mt-7 w-full flex  justify-center">
            ...
            >
              ...
              <div className="text-white px-8 sm:px-16  py-2 sm:py-3">
                LOGIN
              </div>
            </div>
          </div>
          <div className="mt-4  flex flex-col gap-6 mx-5">
            <div className="flex gap-2 flex-col">
              ...
              <div className="relative">
                ...
                <div className="relative">
                {
                    touched.name &&
                    error.name  && (
                        <div className={`${lato.className} text-sm text-red-500 absolute`}>
                            *{error.name}
                        </div>
                    )
                }
